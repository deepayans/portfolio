        ...
        >
          ...
          <div className="mb-8 border border-[rgba(0,229,196,0.2)] bg-[rgba(0,229,196,0.04)] p-6">
            ...
            <p className="mb-4 text-sm text-white/50">
              Based in {resume.basics.location} with {resume.basics.workAuth}. Open to internship and CDI roles in data science, machine learning, and analytics across the EU.
            </p>
